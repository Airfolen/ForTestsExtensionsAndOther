...
public class SplitCandleBackupConfiguration : IEntityTypeConfiguration<SplitCandleBackup>
{
    public void Configure(EntityTypeBuilder<SplitCandleBackup> builder)
    {
        ...
        builder.ToTable("split_m1_backup");

        builder.Property(x => x.SplitId)
            .HasColumnName("split_id");

        builder.Property(x => x.SplitTradeDate)
